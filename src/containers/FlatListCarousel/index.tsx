...
const Backdrop = ({ scrollX }: any) => {
  const backgroundColor: string = scrollX.interpolate({
    inputRange: bgs.map((_, i: number) => i * width),
    outputRange: bgs.map((bg: string) => bg),
  });
...
export default function FlatListCarousel() {
